...
// transparent.
func (el *Line) SetOutlineDash(first, second float64, others ...float64) {
	otherStr := ""
...
func (el *Line) SetHoverOutlineDash(first, second float64, others ...float64) {
	otherStr := ""
	for _, i := range others {
		otherStr += fmt.Sprintf(" %v", i)
	}
...
func (el *Line) SetDisabledOutlineDash(first, second float64, others ...float64) {
	otherStr := ""
	for _, i := range others {
		otherStr += fmt.Sprintf(" %v", i)
	}
...
func (el *Line) SetOutlineDashOffset(offset float64) {
