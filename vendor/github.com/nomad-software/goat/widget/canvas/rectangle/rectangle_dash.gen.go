...
// transparent.
func (el *Rectangle) SetOutlineDash(first, second float64, others ...float64) {
	otherStr := ""
...
func (el *Rectangle) SetHoverOutlineDash(first, second float64, others ...float64) {
	otherStr := ""
	for _, i := range others {
		otherStr += fmt.Sprintf(" %v", i)
	}
...
func (el *Rectangle) SetDisabledOutlineDash(first, second float64, others ...float64) {
	otherStr := ""
	for _, i := range others {
		otherStr += fmt.Sprintf(" %v", i)
	}
...
func (el *Rectangle) SetOutlineDashOffset(offset float64) {
