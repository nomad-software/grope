...
func (el *Rectangle) SetOutlineColor(color string) {
...
// See [option.color] for color names.
func (el *Rectangle) SetHoverOutlineColor(color string) {
...
// See [option.color] for color names.
func (el *Rectangle) SetDisabledOutlineColor(color string) {
