...
// transparent.
func (el *Oval) SetOutlineDash(first, second float64, others ...float64) {
	otherStr := ""
...
func (el *Oval) SetHoverOutlineDash(first, second float64, others ...float64) {
	otherStr := ""
	for _, i := range others {
		otherStr += fmt.Sprintf(" %v", i)
	}
...
func (el *Oval) SetDisabledOutlineDash(first, second float64, others ...float64) {
	otherStr := ""
	for _, i := range others {
		otherStr += fmt.Sprintf(" %v", i)
	}
...
func (el *Oval) SetOutlineDashOffset(offset float64) {
